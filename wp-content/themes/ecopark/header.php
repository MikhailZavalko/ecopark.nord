...
<head>
	...
	<link rel="stylesheet" id="main" href="<?php echo $template_url; ?>/css/main.min.css?v=1.11" type="text/css" media="all">
	...
	<header class="header">
		<div class="container">
			...
			<div class="main-head">
				...
				<a href="tel:+7(4212) 68-00-11" class="header-phone">
					<div class="circle-phone">
					...
					<p><span>+7 (4212) 68-00-11</span><br>г. Хабаровск</p>
				</a>
